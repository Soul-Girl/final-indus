          ...
          <div class="row">
            <div class="booking-form">
              ...
              <form class="bl1" action="includes/register.php" name="reg" method="POST">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="room" required>
                        <option value="SingleRoom">Single Bed (₹1199)</option>
                        <option value="DoubleRoom">Double Bed (₹1899)</option>
                        <option value="FamilyRoom">Family Size (₹2499)</option>
                      </select>
                      <span class="select-arrow"></span>
                    </div>
                  </div>
                ...
                <p class="note"> *Prices are per day basis <br><br> *Including all taxes </p>
              </form>
            </div>
          </div>
        </div>
